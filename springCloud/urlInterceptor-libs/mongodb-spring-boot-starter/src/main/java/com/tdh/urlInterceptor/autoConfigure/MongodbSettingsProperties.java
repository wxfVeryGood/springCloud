...
/**
 * 
 * @ClassName: MongodbSettingsProperties  
 * @Description: (mongodb初始化配置信息)  
 * @author wxf
 * @date 2018年11月22日 下午3:32:55  
 *
 */
@ConfigurationProperties(prefix = MongodbSettingsProperties.MONGODB_PREFIX)
public class MongodbSettingsProperties {
